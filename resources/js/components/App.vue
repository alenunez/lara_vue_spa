        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container-fluid">
                <a class="navbar-brand" href="#">
                    ...
                    <img src="http://assets.stickpng.com/images/58482acecef1014c0b5e4a1e.png" alt="" width="30" height="24">
                </a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <router-link exact-active-class="active" to="/mostrar" class="nav-link">Blogs</router-link>
                    </li>   
                     <li class="nav-item">
